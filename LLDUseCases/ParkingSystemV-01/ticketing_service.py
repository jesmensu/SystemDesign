...
class Ticket:
    def __init__(self, vehicle, parking_spot, park_time = None, ticket_no = None):
        self.vehicle_no = vehicle.vehicle_no
        self.vehicle_type = vehicle.vehicle_type
        self.park_time = time.time() if park_time == None else park_time
    ...
    def print_ticket(self):
        ...
        print("Parking Spot No: ", self.parking_spot)
